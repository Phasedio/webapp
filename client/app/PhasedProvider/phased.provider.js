angular.module('webappApp')
  .provider('Phased', function() {
    ...
    var _Auth, _viewType = 'notPaid', _billingInfo, _taskPriorities, _taskStatuses,
      _team = { name : 'unset' }, // set in config after init
      _currentUser = '',
      FBRef = '';
    ...
    */
    ...
    // gathers categories data and adds to _team
    ...
    *
    * doCallbacks
    * checks if a callback has been requested (on a module-by-module basis)
    * executes
    *
    */
    var doCallbacks = function() {
      for (var i in req_callbacks) {
        req_callbacks[i].callback(req_callbacks[i].args);
      }
    }
    ...
    * otherwise, add it to the list of things to do (this just got too close to RL...)
    *
    */
    ...
    */
    var _watchAssignments = function(args) {
      registerAsync(asyncWatchAssignments, args);
    }
    ...
    * called in AuthProviders doAfterAuth callback
    *
    */
